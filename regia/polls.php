...
<body class="stretched">
	...
	window.setInterval(function(){
		...
		// AGGIORNAMENTO REALTIME questions A RISPOSTA LIBERA
		...
		$.ajax({
			...
			success: function(data){
				...
				for (var i = 0; i < polls_master.length; i++) {
					//console.log(polls_master[i]+"_____________");	
		...
		// AGGIORNAMENTO REALTIME questions A RISPOSTA MULTIPLA
		...
		//AGGIORNO IN REALTIME GLI STATI DELLE questions
		$.ajax({
